...
// v0 scaffold for: No client-website embeddable badge
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-client-website-embeddable-badge/run.

export default function ClientWebsiteEmbeddableBadgePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-client-website-embeddable-badge/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No client-website embeddable badge</h1>
