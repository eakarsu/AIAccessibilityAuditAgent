...
// v0 scaffold for: Computer-vision alt-text auto-generation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-computer-vision-alt-text-auto/run.

export default function ComputerVisionAltTextAutoPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-computer-vision-alt-text-auto/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Computer-vision alt-text auto-generation</h1>
