...
// v0 scaffold for: No large-scale crawling / spidering
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-large-scale-crawling-spidering/run.

export default function LargeScaleCrawlingSpideringPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-large-scale-crawling-spidering/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No large-scale crawling / spidering</h1>
