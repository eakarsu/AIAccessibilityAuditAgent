...
// v0 scaffold for: No automated HTML remediation rewriter
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-automated-html-remediation-rewriter/run.

export default function AutomatedHtmlRemediationRewriterPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-automated-html-remediation-rewriter/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No automated HTML remediation rewriter</h1>
